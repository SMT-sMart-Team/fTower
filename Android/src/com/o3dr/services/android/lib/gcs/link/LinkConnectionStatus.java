 ...
 * extra value {@link LinkEventExtra#EXTRA_CONNECTION_STATUS}
 * when the attribute event is {@link LinkEvent#LINK_STATE_UPDATED}
 */
public final class LinkConnectionStatus implements Parcelable {
     ...
     * {@link #EXTRA_ERROR_CODE}. A {@link FailureCode}
    ...
    /**
     * All errors that are not one of the listed {@link FailureCode}s.
    ...
    /**
     * @return Returns the status of the link connection. This value is one of {@link StatusCode}
     */
    @StatusCode
    ...
    public static final Creator<LinkConnectionStatus> CREATOR = new Creator<LinkConnectionStatus>() {
     ...
     * @param failureCode Of type {@link FailureCode}
