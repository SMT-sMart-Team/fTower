...
public class AttributeEvent {
     ...
     *
     * @see {@link AttributeEventExtra#EXTRA_AUTOPILOT_ERROR_ID}
     */
     ...
     * The message content can be retrieved using the {@link AttributeEventExtra#EXTRA_AUTOPILOT_MESSAGE} key.
     * The message level can be retrieved using the {@link AttributeEventExtra#EXTRA_AUTOPILOT_MESSAGE_LEVEL} key.
     */
