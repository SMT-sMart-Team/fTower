...
public enum MissionItemType {
    ...
    WAYPOINT("Waypoint") {
        ...
        @Override
        protected Creator<Waypoint> getMissionItemCreator() {
    ...
    SPLINE_WAYPOINT("Spline Waypoint") {
        ...
        @Override
        protected Creator<SplineWaypoint> getMissionItemCreator() {
    ...
    TAKEOFF("Takeoff") {
        ...
        @Override
        protected Creator<Takeoff> getMissionItemCreator() {
    ...
    CHANGE_SPEED("Change Speed") {
        ...
        @Override
        protected Creator<ChangeSpeed> getMissionItemCreator() {
