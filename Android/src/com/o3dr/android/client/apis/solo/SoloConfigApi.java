...
public class SoloConfigApi extends SoloApi {
     ...
     *
     * @param controllerMode Controller mode. @see {@link SoloControllerMode.ControllerMode}
     * @param listener       Register a callback to receive update of the command execution status.
     */
     ...
     * @param controllerUnit Controller unit system. @see {@link SoloControllerUnits.ControllerUnit}
