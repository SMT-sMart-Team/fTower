 ...
 */
class AMapPrefFragment : MapProviderPreferences(), EditInputDialog.Listener {
    ...
    companion object PrefManager {
        ...
        val PREF_AMAP_TILE_PROVIDER_SETTINGS = "pref_amap_tile_provider_settings"
        ...
        fun getMapType(context: Context?): Int {
            ...
            context?.let {
                ...
                when(selectedType){
//                    MAP_TYPE_HYBRID -> mapType = AMap.MAP_TYPE_HYBRID
                    MAP_TYPE_NORMAL -> mapType = AMap.MAP_TYPE_NORMAL
//                    MAP_TYPE_TERRAIN -> mapType = AMap.MAP_TYPE_TERRAIN
    ...
    private fun setupPreferences() {
        ...
        setupAMapTileProviderPreferences(sharedPref)
    ...
    private fun setupTileProvidersPreferences(sharedPref: SharedPreferences) {
        ...
        providerSettingsScreens.put(GoogleMapPrefConstants.AMAP_TILE_PROVIDER, findPreference(PREF_AMAP_TILE_PROVIDER_SETTINGS) as PreferenceCategory)
    ...
    private fun setupAMapTileProviderPreferences(sharedPref: SharedPreferences) {
        val mapTypeKey = PREF_MAP_TYPE
        val mapTypePref = findPreference(mapTypeKey)
        mapTypePref?.let {
            mapTypePref.summary = sharedPref.getString(mapTypeKey, DEFAULT_MAP_TYPE)
    ...
    private fun toggleTileProviderPrefs(@TileProvider tileProvider: String){
        ...
        when(tileProvider){
            ...
            GoogleMapPrefConstants.AMAP_TILE_PROVIDER -> setupAMapTileProviderPreferences(sharedPref)
